...
$sql="select muelaDiente,terapia from odontograma where idPacientes=".$_GET['id'];
...
$pdf->setX(40);
$pdf->Cell(40,10,'Odontograma del paciente '.utf8_decode($_GET['nombre']." ".$_GET['apellido']),0,2);
...
{
$pdf->Cell(40,10,$row['muelaDiente'],1);
