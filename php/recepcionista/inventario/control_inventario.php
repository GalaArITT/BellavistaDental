...
$sql="insert into inventario(nombre,cantidad) values('$nombre',$cantidad)";
    if(mysql_query($sql))
    {
      echo("Utensilio insertado correctamente-PrincipalRecepcionista.php?action=verInventario");
    }
}
...
$sql="update inventario set nombre='$nombre', cantidad=$cantidad where id_utensilio=$id ";
 ...
 if(mysql_query($sql))
    {
      echo("Utensilio modificado correctamente-PrincipalRecepcionista.php?action=verInventario");
    }
}
?>