...
foreach ($arreglo as $row) 
{
    echo "<tr>
     ...
     echo("<a href='PrincipalRecepcionista.php?action=paso2&&idPac=".$row['idPacientes']."&&paciente=". utf8_encode($row['Pac_nombre']) ." ". utf8_encode($row['Pac_apellido']) ." '>Seleccionar</a>
              </div>
              </div>
              </td></tr>");
