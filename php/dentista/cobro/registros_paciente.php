<h2>Expide un recibo de pago</h2>
<h3>Paso 1: Selecciona al paciente al que le expediras un recibo de pago</h3>
<?php 
...
foreach ($arreglo as $row) 
{
    echo "<tr>
     ...
     echo("<a href='PrincipalDentista.php?action=paso2Co&&idPac=".$row['idPacientes']."&&paciente=". utf8_encode($row['Pac_nombre']) ." ". utf8_encode($row['Pac_apellido']) ." '>Seleccionar</a>
              </div>
              </div>
              </td></tr>");
