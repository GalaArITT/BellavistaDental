...
<div id="col1">
   ...
   ?>
    ...
    <form  type="post" id='formularioAsunto'>
         <h3>Paso 2: Selecciona una fecha y un asunto</h3>
        <input type='hidden' id='seleccDentista' value='<?php echo($_SESSION['id']); ?>'>
        <input id="fecha_cita" type="date"   onchange="buscaFecha()" name="fecha" min="<?php echo  $fecha_min; ?>" max="<?php echo $fecha_max;?>";>
...
function buscaFecha()
{
  ...
  var id_dentista=dentista.value;
  ...
  var asunto=document.getElementById("asunto").value; 
    ...
    var formData = new FormData();
     ...
     formData.append("accion","obtenHorario");
        $.ajax({
            url:"dentista/cita/controlHorario.php",
            type:"post",
            datatype:'html',
            data:formData,
            cache:false,
